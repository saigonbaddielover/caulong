...
├── design/
│   └── template.html                 # UI mock/dev, source of truth cho phần giao diện
├── docs/
│   ├── template-sync-contract.md     # Contract sync UI giữa template/index
│   └── template-sync-checklist.md    # Checklist workflow sync
├── scripts/
│   ├── daily-reset.js                # Script reset slot hàng ngày
│   └── sync-template.js              # Sync các zone UI từ template -> index
├── .github/
│   └── workflows/
...
`design/template.html` là source of truth cho UI. Sau khi chỉnh giao diện:
...
- `docs/template-sync-contract.md`
- `docs/template-sync-checklist.md`
